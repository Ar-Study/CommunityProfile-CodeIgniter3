            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box">
                        ...
                        <!-- /.info-box-content -->
                        <p><a href="<?php echo base_url('admin/berita')?>" class="btn btn-outline-dark ">Detail</a></p>
                    </div>
                    <!-- /.info-box -->
                </div>
                <!-- /.col -->
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <!-- /.info-box-content -->
                        <p><a href="<?php echo base_url('admin/galeri')?>" class="btn btn-outline-dark ">Detail</a></p>
                    </div>
                    <!-- /.info-box -->
                </div>
                <!-- /.col -->
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <!-- /.info-box-content -->
                        <p><a href="<?php echo base_url('admin/kegiatan')?>" class="btn btn-outline-dark ">Detail</a></p>
                    </div>
                    <!-- /.info-box -->
                </div>
                <!-- /.col -->
